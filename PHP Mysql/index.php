<?php
// conexão com o BD
$mysqli = mysqli_connect('localhost', 'root', 'senaisp', 'Somativa');
		...
		<body>
			<table>
				<tr>
					...
					<th><a href="index.php?column=carga_horaria&order=<?php echo $asc_or_desc; ?>">Carga_horaria<i class="fas fa-sort<?php echo $column == 'carga_horaria' ? '-' . $up_or_down : ''; ?>"></i></a></th>
					<th><a href="index.php?column=descricao&order=<?php echo $asc_or_desc; ?>">Descricao <i class="fas fa-sort<?php echo $column == 'descricao' ? '-' . $up_or_down : ''; ?>"></i></a></th>
				</tr>
